...
# Multivariate OLS Regression & Inferential Testing (Model A - Industry Model with HC3 Robust SE)
...
print(f"  Jarque-Bera Stat       : {jb_test[0]:.4f}, p-value: {jb_test[1]:.4e} (Right-skewed residual tail distribution)")
